  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">API ขององค์กร</h1>
          <p className="text-gray-500 mt-1">จัดการ API ที่องค์กรสมัครใช้งาน</p>
        </div>
                ...
                return (
                  <tr key={api.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <div>
                        <Link
                          href={`/organization/catalog/${api.id}`}
                        ...
                        {openMenuId === api.id && (
                          <>
                            ...
                            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                              ...
                              <Link
                                href={`/organization/credentials?api=${api.id}`}
                                className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                                onClick={() => setOpenMenuId(null)}
                              >
                              ...
                              <Link
                                href={`/organization/usage?api=${api.id}`}
                                className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                                onClick={() => setOpenMenuId(null)}
                              >
